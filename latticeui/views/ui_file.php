<div id="<?=$id;?>"  class="ui-FileElement field-<?=$field;?> extensions-<?=str_replace(',','_',$extensions);?> maxLength-<?=$maxlength;?> <?=$class;?> ">
	...
	<div class="wrapper">
		...
		<img src="<?=url::site('lattice/latticecms/views/images/bar.gif', null, false);?>" class="progress" />
