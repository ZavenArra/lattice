...
// Load this file's selection again by visiting: http://mootools.net/more/99cfe391cd7588939e5d2dab4b5bad65 
// Or build this file again with packager using: packager build More/Events.Pseudos More/Class.Refactor More/Class.Binds More/Class.Occlude More/Array.Extras More/String.Extras More/String.QueryString More/URI More/URI.Relative More/Element.Forms More/Elements.From More/Element.Event.Pseudos More/Element.Event.Pseudos.Keys More/Element.Delegation More/Element.Measure More/Element.Position More/Element.Shortcuts More/Form.Validator More/Form.Validator.Inline More/Form.Validator.Extras More/OverText More/Fx.Accordion More/Fx.Scroll More/Fx.SmoothScroll More/Fx.Sort More/Drag More/Drag.Move More/Slider More/Sortables More/Assets More/Hash.Cookie More/Keyboard More/Keyboard.Extras More/Scroller More/Spinner
/*
---
copyrights:
...
}}g[f]=g[f].round();}if(g.y||g.x){this.fireEvent("change",[a.x+g.x,a.y+g.y]);}}});var IframeShim=new Class({Implements:[Options,Events,Class.Occlude],options:{className:"iframeShim",src:'javascript:false;document.write("");',display:false,zIndex:null,margin:0,offset:{x:0,y:0},browsers:(Browser.ie6||(Browser.firefox&&Browser.version<3&&Browser.Platform.mac))},property:"IframeShim",initialize:function(b,a){this.element=document.id(b);
